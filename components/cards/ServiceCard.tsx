        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
            <div>
                ...
                <p className="text-customGrayAlt2 text-[1/125rem] mt-[0.75rem]">
                    ...
                    magic of your special occasions. Whether it&apos;s a
                    wedding, corporate event, or milestone celebration,
                    we&apos;re there to document every heartfelt moment. We
                    blend into the background, ensuring natural and candid shots
                ...
                <div className="flex flex-col gap-[0.62rem]">
                    {serviceHighlightData.map((highlight, index) => (
                        ...
                        >
                            <img
                                src="/images/legged_stars_gray.png"
                                alt="gray star"
                            />
